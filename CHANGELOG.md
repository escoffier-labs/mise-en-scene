...
- Print-styled PDF export that rasterizes the active view onto a single landscape page with margins, gated by the same foreignObject capability probe as PNG.
